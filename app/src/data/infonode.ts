...
export const NodeClassMore: Record<string, Record<string, string>> = {
  pl: {
    ...
    corp: "alarmy, śledzenie włamywacza",
    mil: "alarmy, śledzenie włamywacza",
    ai: "LOD czarny lub biały, SI może wybrać",
  },
  en: {
    pub: "-",
    priv: "-",
    ...
    ai: "black or white ICE, AI can choose",
  },
};
...
export const infoData: Record<string, Record<string, string[]>> = {
  pl: {
    ...
    privsec: [
      ...
      "Dokument odbioru cybermodu wartego do 5 tys.",
      "Dokument odbioru drona bojowego",
    ],
    gov: [
    ...
    ai: [
      ...
      "Kody kontrolne automatycznego lotniskowca",
      "Kody kontrolne kolejki podziemnej",
