...
const npcGoal = [
  ...
  "Zbudować własne SI",
  "Wystąpić przed publicznością z własną piosenką",
  "Każda informacja powinna być powszechnie dostępna!",
...
const npcLook = [
  ...
  " Dysk z kolekcją wirusów komputerowych",
  "Kuloodporna kurtka i skuter",
  ...
  "Rytualne blizny na twarzy i wszczepiony dozownik endorfin",
